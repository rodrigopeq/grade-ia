...
import br.projeto.grade.MainApp;
...
public class HomePage extends JFrame {
	...
	public HomePage() {
		...
		scrollPane.setBounds(5, 5, 780, 660);
...
//		DefaultTableModel x = new DefaultTableModel();
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Não foi encontrado nenhum resultado possivel", "Alerta", JOptionPane.ERROR_MESSAGE);
			e.printStackTrace();
		}
		DesenhaGrade grade = new DesenhaGrade(app.getDisciplinas());
		
		Object[][] data = {
			    {"13:00h-13:50h",grade.SEG1,grade.TER1,grade.QUA1,grade.QUI1,grade.SEX1},
